...
public class BungeeCore extends Plugin {
    ...
    public void onEnable() {
        ...
        ProxyServer.getInstance().getConsole().sendMessage("§a"+ BungeeCore.getInstance().getDescription().getName() + " §7enabled!");
        ProxyServer.getInstance().getConsole().sendMessage("§7Creator: §eDanika6677");
        ProxyServer.getInstance().getConsole().sendMessage("§7Version: §e" + BungeeCore.getInstance().getDescription().getVersion());
    ...
    public void onDisable() {
        ...
        ProxyServer.getInstance().getConsole().sendMessage("§a"+ BungeeCore.getInstance().getDescription().getName() + " §7disabled!");
        ProxyServer.getInstance().getConsole().sendMessage("§7Creator: §eDanika6677");
        ProxyServer.getInstance().getConsole().sendMessage("§7Version: §e" + BungeeCore.getInstance().getDescription().getVersion());
        ProxyServer.getInstance().getConsole().sendMessage("§7BungeeCord: " + ChatColor.YELLOW + ProxyServer.getInstance().getName() +"§8-§a"+ ProxyServer.getInstance().getVersion());
        ProxyServer.getInstance().getConsole().sendMessage("§8-------------------------------------------------------------");
    ...
    public void loadConfig() {
        ...
        if (!file.exists())
            try (InputStream in = getResourceAsStream("config.yml")) {
                ...
                ProxyServer.getInstance().getConsole().sendMessage("§8-------------------------------------------------------------");
                ProxyServer.getInstance().getConsole().sendMessage("§a"+ BungeeCore.getInstance().getDescription().getName() + " §8disabled!");
                ProxyServer.getInstance().getConsole().sendMessage("§7Creator: §eDanika6677");
                ProxyServer.getInstance().getConsole().sendMessage("§7Version: §e" + BungeeCore.getInstance().getDescription().getVersion());
                ProxyServer.getInstance().getConsole().sendMessage(" ");
                ProxyServer.getInstance().getConsole().sendMessage("§7Error Occured when creating the config!");
        ...
        try {
            ...
            ex.printStackTrace();
            String error2 = ChatColor.GRAY + "Error: "+ ChatColor.GREEN + ex;
            ProxyServer.getInstance().getConsole().sendMessage("§8-------------------------------------------------------------");
            ProxyServer.getInstance().getConsole().sendMessage("§a"+ BungeeCore.getInstance().getDescription().getName() + " §8disabled!");
            ProxyServer.getInstance().getConsole().sendMessage("§7Creator: §eDanika6677");
            ProxyServer.getInstance().getConsole().sendMessage("§7Version: §e" + BungeeCore.getInstance().getDescription().getVersion());
            ProxyServer.getInstance().getConsole().sendMessage(" ");
            ProxyServer.getInstance().getConsole().sendMessage("§7Error Occured when loading the config classes!");
    ...
    public void saveConfig() {
        ...
        try {
            ...
            exc.printStackTrace();
            String error3 = ChatColor.GRAY + "Error: "+ ChatColor.GREEN + exc;
            ProxyServer.getInstance().getConsole().sendMessage("§8-------------------------------------------------------------");
            ProxyServer.getInstance().getConsole().sendMessage("§a"+ BungeeCore.getInstance().getDescription().getName() + " §8disabled!");
            ProxyServer.getInstance().getConsole().sendMessage("§7Creator: §eDanika6677");
            ProxyServer.getInstance().getConsole().sendMessage("§7Version: §e" + BungeeCore.getInstance().getDescription().getVersion());
            ProxyServer.getInstance().getConsole().sendMessage(" ");
            ProxyServer.getInstance().getConsole().sendMessage("§7Error Occured when loading the config!");
